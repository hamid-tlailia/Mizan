...
const gradeStyles = {
  positive: { className: "bg-emerald-100 text-emerald-800 ring-emerald-200 dark:bg-emerald-950/70 dark:text-emerald-300 dark:ring-emerald-900", icon: CheckCircle2 },
  ...
  return (
    <section className="mx-auto mt-10 w-full max-w-4xl animate-in fade-in slide-in-from-bottom-3 duration-500" aria-labelledby="result-title">
      <div className="research-card overflow-hidden">
        <div className="border-b border-border bg-gradient-to-l from-emerald-950 via-emerald-900 to-emerald-800 px-5 py-5 text-emerald-50 sm:px-7">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-3"><span className="grid size-9 place-items-center rounded-xl bg-white/10"><ScrollText className="size-5" /></span><div><p className="text-xs font-semibold text-emerald-200">نتيجة الفحص</p><h2 id="result-title" className="text-lg font-bold">خلاصة التخريج والتحليل</h2></div></div>
        ...
        <article className="p-5 sm:p-7">
          ...
          <div className="hadith-text hadith-safe-text my-6 max-w-full rounded-2xl border border-amber-700/10 bg-amber-50/70 px-5 py-6 text-center text-[1.32rem] leading-[2.5] text-foreground dark:border-amber-300/10 dark:bg-amber-100/5 sm:px-8 sm:text-[1.55rem]">{result.matn}</div>
